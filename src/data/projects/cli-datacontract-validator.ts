...
export const cliDatacontractValidator: Project = {
  slug: "cli-datacontract-validator", // usado en la URL → /project/project-slug
  title: "CLI DataContract Validator",
  subtitle: "Your command-line tool for validating data contracts",
  year: 2025,
  cover: "/images/projects/example/shot3.jpg",
  ...
  i18nKey: "cliDatacontractValidator", // CLAVE que conecta con i18n
};
